...
// draw border
        ...
        if (animateFirstTime) {
            ...
            if (rocketXSpeed > 0 && gameOver == false)
            {
            BackgroundXPos1-=rocketXSpeed/6;
            }
            if (rocketXSpeed < 0 && gameOver == false)
            {
            BackgroundXPos1 -=rocketXSpeed/6;
            ...
            g.drawImage(outerSpaceImage,(int)(BackgroundXPos1),Window.getY(0),
                1920,Window.getHeight2(),this);
            
            for (int j = 0; j < 200 ; j++)
            {
                g.drawImage(outerSpaceImage,(int)(BackgroundXPos1) + 1920 * j,Window.getY(0),
                1920,Window.getHeight2(),this);
        ...
        for (int i=0;i<missiles.size();i++)
            missiles.get(i).draw(this,g,missleImage);   
...
/////////////////////////////////////////////////////////////////////////
    public void animate() {
        ...
        for (int i=0;i<stars.size();i++)
        {
         ...
         stars.get(i).move((int)(-rocketXSpeed));
